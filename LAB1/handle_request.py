...
def handle_request(request_data, base_dir):
    ...
    try:
        ...
        if not os.path.abspath(file_path).startswith(os.path.abspath(base_dir)):
            ...
            body = error_template.format(code=403, title="Forbidden", message="You don't have permission to access this resource.").encode('utf-8')
        ...
        if not os.path.exists(file_path):
            ...
            body = error_template.format(code=404, title="Not Found", message="The requested resource could not be found on this server.").encode('utf-8')
        ...
        if os.path.isfile(file_path):
            ...
            if ext not in MIME_TYPES:
                ...
                body = error_template.format(code=404, title="Not Found", message="Unsupported file type.").encode('utf-8')
                return create_response(404, "Not Found", "text/html", body)
        ...
        body = error_template.format(code=500, title="Internal Server Error", message="An unexpected error occurred while processing your request.").encode('utf-8')
